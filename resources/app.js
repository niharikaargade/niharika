...
const timeline = [
  ...
  {
    year: "2020-now",
    title: "Fourier Technologies",
    place: "Software consultant and full stack development",
    city: "Pune",
    detail:
      "This is where product work grew across app development, backend services, AWS, IoT workflows, and end-to-end delivery.",
    type: "work",
  },
  {
    year: "2020-now",
    title: "Nuro Tech",
    place: "Worked through Fourier on product and engineering delivery",
    city: "Pune + remote work",
    detail:
      "The work here involved connected-device systems, production cloud workflows, mobile features, and solving the practical issues that show up in real deployments.",
    type: "work",
  },
  {
    year: "2020-now",
    title: "Hexatic",
    place: "Product and engineering work across app and systems flows",
    city: "Pune + remote work",
    detail:
      "This added another layer of product exposure, from implementation detail to shipping features that had to work reliably in the hands of real users.",
    type: "work",
  },
];
